            ...
            <div class="alt_info">
                <div class="alt_non_breakdown" v-if="!isBreakdown">
                    <div>
                        ...
                        <p>{{ unlockedText }} FUEL</p>
                    </div>
                    <div v-if="hasLocked">
                        <label>{{ $t('top.locked') }}</label>
                        <p>{{ balanceTextLocked }} FUEL</p>
                    </div>
                    <div v-if="hasMultisig">
                        <label>Multisig</label>
                        <p>{{ balanceTextMultisig }} FUEL</p>
                    </div>
                    <div>
                        <label>{{ $t('top.balance.stake') }}</label>
                        <p>{{ stakingText }} FUEL</p>
                    </div>
                </div>
                <div class="alt_breakdown" v-else>
                    <div>
                        <label>{{ $t('top.balance.available') }} (X)</label>
                        <p>{{ avmUnlocked | cleanAvaxBN }} FUEL</p>
                        <label>{{ $t('top.balance.available') }} (P)</label>
                        <p>{{ platformUnlocked | cleanAvaxBN }} FUEL</p>
                        <label>{{ $t('top.balance.available') }} (C)</label>
                        <p>{{ evmUnlocked | cleanAvaxBN }} FUEL</p>
                    </div>
                    <div v-if="hasLocked">
                        <label>{{ $t('top.balance.locked') }} (X)</label>
                        <p>{{ avmLocked | cleanAvaxBN }} FUEL</p>
                        <label>{{ $t('top.balance.locked') }} (P)</label>
                        <p>{{ platformLocked | cleanAvaxBN }} FUEL</p>
                        <label>{{ $t('top.balance.locked_stake') }} (P)</label>
                        <p>{{ platformLockedStakeable | cleanAvaxBN }} FUEL</p>
                    </div>
                    <div v-if="hasMultisig">
                        <label>Multisig (X)</label>
                        <p>{{ avmMultisig | cleanAvaxBN }} FUEL</p>
                        <label>Multisig (P)</label>
                        <p>{{ platformMultisig | cleanAvaxBN }} FUEL</p>
                    </div>
                    <div>
                        <label>{{ $t('top.balance.stake') }}</label>
                        <p>{{ stakingText }} FUEL</p>
...
import { BN } from '@savannah-labs/savannahjs/dist'
...
export default class BalanceCard extends Vue {
    ...
    // Locked balance is the sum of locked FUEL tokens on X and P chain
