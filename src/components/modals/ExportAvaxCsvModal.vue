<template>
    <modal ref="modal" title="Export FUEL Transfers" class="modal_main">
        <div class="csv_modal_body">
            <p>Export FUEL transactions including cross chain transfers on X,P and C chains.</p>
...
import { createCsvNormal, getHistoryForOwnedAddresses } from '@savannah-labs/savannah-wallet-sdk'
